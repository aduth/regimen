...
export default function PrivacyRoute() {
	return (
		<Page title="Privacy Policy">
			<Content>
				<Block title="Privacy Policy" padded>
					...
					<ol type="a">
						<li>
							...
							(information or software) on Regimen's web site for personal,
							non-commercial transitory viewing only. This is the grant of a license,
							not a transfer of title, and under this license you may not:
							<ol type="i">
								<li>modify or copy the materials;</li>
								<li>use the materials for any commercial purpose, or for any public display (commercial or non-commercial);</li>
								<li>attempt to decompile or reverse engineer any software contained on Regimen's web site;</li>
						...
						<li>
							...
							restrictions and may be terminated by Regimen at any time. Upon
					...
					<ol type="a">
						<li>
							The materials on Regimen's web site are provided "as is". Regimen makes
							...
							Further, Regimen does not warrant or make any representations
					...
					<h3>4. Limitations</h3>
					<p>
						In no event shall Regimen or its suppliers be liable for any damages
						...
						materials on Regimen's Internet site, even if Regimen or a Regimen
					...
					<p>
						The materials appearing on Regimen's web site could include technical,
						typographical, or photographic errors. Regimen does not warrant that any
						of the materials on its web site are accurate, complete, or current.
						Regimen may make changes to the materials contained on its web site at
						any time without notice. Regimen does not, however, make any commitment to
						update the materials.
					</p>
					<h3>6. Links</h3>
					<p>
						Regimen has not reviewed all of the sites linked to its Internet web site
						and is not responsible for the contents of any such linked site. The
						inclusion of any link does not imply endorsement by Regimen of the site.
						Use of any such linked web site is at the user's own risk.
					</p>
					<h3>7. Site Terms of Use Modifications</h3>
					<p>
						Regimen may revise these terms of use for its web site at any time without
					...
					<p>
						Any claim relating to Regimen's web site shall be governed by the laws of
